...
raf_sex <- delete.vertices(raf, V(raf)[type == 2])#löscht alle Anschläge bzw. Aktionen
...
V(ego_bef1)[V(ego_bef1)$type == 2]$shape <- "square" # Aktionen werden als Quadrat dargestellt
...
V(ego_ent1)[V(ego_ent1)$name == "Entfuehrung Hanns Martin-Schleyer 05.09.1977"]$color <- "cornflowerblue" # Aktion wird blau hervorgehoben
