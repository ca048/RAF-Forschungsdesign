...
el <- read.csv("https://raw.githubusercontent.com/ca048/RAF-Forschungsdesign/master/edgelist", header=T, as.is=T, sep = ",")

# liest die Nodelist mit den Namen ein
nodes <- read.csv("https://raw.githubusercontent.com/ca048/RAF-Forschungsdesign/master/nodelist", header=T, as.is=T, sep = ",")
