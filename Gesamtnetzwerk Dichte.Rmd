...
```
#GEÄNDERTE ZAHL! Die Dichte des Netzwerks beträgt also 0.0495256, das bedeutet, dass 4,9 % (also etwa 5%) von allen möglichen Beziehungen zwischen den Knoten realisiert wurde. Dies bedeutet auch, dass zwischen 95% der Knoten keine Beziehungen bestehen. Das liegt wohl hauptsächlich daran, dass sich die Mitglieder der ersten und zweiten Generation in den meisten Fällen gar nicht kannten da zeitlich versetzt aktiv.
