...
```{r Ego-Netzwerk Brigitte Mohnhaupt, echo=FALSE, fig.height=10, fig.width=16}
...
```{r Ego-Netzwerk Peter-Jürgen Boock, echo=FALSE, fig.height=14, fig.width=20, message=FALSE, warning=FALSE, paged.print=TRUE}
...
```{r Ausgetretene Mitglieder, fig.height=10, fig.width=16, echo=FALSE, message=FALSE, warning=FALSE}
